...
async def empty_query_admin(query: types.InlineQuery):
    ...
    await query.answer(articles, cache_time=5, switch_pm_text='Перейти в админку', switch_pm_parameter='select_item')
